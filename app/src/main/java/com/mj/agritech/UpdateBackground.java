...
public class UpdateBackground extends AsyncTask<String,Void,String> {
    ...
    public UpdateBackground(Context ctx,View v)
    {
        context=ctx;
        view=v;
    ...
    protected String doInBackground(String... voids) {
        type= voids[0];
        login_url= "https://theagriculture.tech/and_files/update.php";
        if(true){
            try {
                ...
                else if(type.equals("familymember"))
                {
                    post_data =
                            URLEncoder.encode("type", "UTF-8") + "=" + URLEncoder.encode(voids[0], "UTF-8") + "&"
                                    ...
                                    + URLEncoder.encode("family_id", "UTF-8") + "=" + URLEncoder.encode(voids[7], "UTF-8")
                                    + "&"
                                    + URLEncoder.encode("member_id", "UTF-8") + "=" + URLEncoder.encode(voids[8], "UTF-8");
