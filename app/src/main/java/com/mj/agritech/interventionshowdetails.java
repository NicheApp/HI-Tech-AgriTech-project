...
public class interventionshowdetails extends AsyncTask<String,Void,String> {
    Context context;
    ...
    interventionshowdetails(Context ctx,FragmentManager fm,int position)
    {
        context=ctx;
        this.fm = fm;
    ...
    protected String doInBackground(String... voids) {
        ...
        String login_url= "http://192.168.43.201/interventionsshow.php";
